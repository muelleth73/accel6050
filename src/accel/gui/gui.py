"""GUI interface for accel using tkinter with integrated logging.

This module provides a graphical user interface for the accel
with settings dialog, file management, and centralized logging capabilities.

run gui: python -m accel.gui
"""
...
from accel.core.base import BaseGPXProcessor
from accel.core.logging import (
    connect_gui_logging,
...
class MainGui:
    ...
    def _open_help(self):
        ...
        webbrowser.open("https://accel.readthedocs.io/en/stable/")

    def _show_about(self):
        """Show about dialog."""
        self.logger.debug("Showing about dialog")
        messagebox.showinfo("About", "accel\n\nCopyright by Paul")
