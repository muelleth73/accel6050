"""CLI interface for accel using the generic config framework.
...
def run_main_processing(config: ConfigParameterManager) -> int:
    ...
    try:
        ...
        logger.info("Starting accel CLI")
...
def main():
    ...
    cli_generator = CliGenerator(config_manager=config_manager, app_name="accel")
