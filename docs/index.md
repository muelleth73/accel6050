...
[![Github CI Status](https://github.com/muelleth73/accel/actions/workflows/main.yml/badge.svg)](https://github.com/muelleth73/accel/actions)
[![GitHub release](https://img.shields.io/github/v/release/muelleth73/accel)](https://github.com/muelleth73/accel/releases)
[![Read the Docs](https://readthedocs.org/projects/accel/badge/?version=stable)](https://accel.readthedocs.io/en/stable/)
[![License](https://img.shields.io/github/license/muelleth73/accel)](https://github.com/muelleth73/accel/blob/main/LICENSE)
[![GitHub issues](https://img.shields.io/github/issues/muelleth73/accel)](https://github.com/muelleth73/accel/issues)
[![PyPI](https://img.shields.io/pypi/v/accel)](https://pypi.org/project/accel/)
[![Downloads](https://pepy.tech/badge/accel)](https://pepy.tech/project/accel/)
...
> **DO NOT FORK** 
> This project is meant to be used from **[Use this template](https://github.com/muelleth73/accel/generate)** feature.

---

1. **Create a new repository using GitHub template**  
   Click on **[Use this template](https://github.com/muelleth73/accel/generate)**.
...
```bash
accel-cli [OPTIONS] path/to/file
```
